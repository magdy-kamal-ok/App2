...
class MenuBar: UIView,UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource{
    ...
    let cellId = "cellId"
    let imageNames = ["home","trend","subs","account"]
    ...
    func setupHorizontalBar(){
        ...
        // the new school of ios 9 layout view
        // need x,y,width,height constraints
        
        horizontalBarView.translatesAutoresizingMaskIntoConstraints = false
        
        horizontalBarLeftAnchorConstraint = horizontalBarView.leftAnchor.constraint(equalTo: self.leftAnchor)//.isActive = true
...
class MenuCell: BaseCell {
    ...
    override var isHighlighted: Bool{
        didSet{
            imageView.tintColor = isHighlighted ? UIColor.white
    ...
    override var isSelected: Bool{
        didSet{
            imageView.tintColor = isSelected ? UIColor.white
                :UIColor.rgb(red: 91, green: 14, blue: 13, alpha: 1)
